<style>
@import url(https://viecnhanong.com/public/themes/lara-mag-product/assets/css/lara-mag.css);
</style>
...
@endif
        @foreach(get_popular_posts($config['number_display'], ['where' => ['status' => 1, 'format_type' => 'video']]) as $post)
            <a class="sidebar-video-item form-popup thumb-full fleft" href="{{ route('public.single', $post->slug) }}" rel="video-popup">
